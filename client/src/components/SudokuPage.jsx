  ...
  return (
    <>
      ...
      <div className="board">
        <div className="row">
          <input
            className={`box ${inUse == "box1" ? "selected" : ""}`}
            id="box1"
            onClick={() => boxClickHandle("box1")}
            value={board.box1}
            onChange={boxInputHandle}
          />
          <input
            className={`box ${inUse == "box2" ? "selected" : ""}`}
            id="box2"
            onClick={() => boxClickHandle("box2")}
            value={board.box2}
            onChange={boxInputHandle}
          />
          <input
            className={`box ${inUse == "box3" ? "selected" : ""}`}
            id="box3"
            onClick={() => boxClickHandle("box3")}
            value={board.box3}
            onChange={boxInputHandle}
          />
        </div>
        <div className="row">
          <input
            className={`box ${inUse == "box4" ? "selected" : ""}`}
            id="box4"
            onClick={() => boxClickHandle("box4")}
            value={board.box4}
            onChange={boxInputHandle}
          />
          <input
            className={`box ${inUse == "box5" ? "selected" : ""}`}
            id="box5"
            onClick={() => boxClickHandle("box5")}
            value={board.box5}
            onChange={boxInputHandle}
          />
          <input
            className={`box ${inUse == "box6" ? "selected" : ""}`}
            id="box6"
            onClick={() => boxClickHandle("box6")}
            value={board.box6}
            onChange={boxInputHandle}
          />
        </div>
        <div className="row">
          <input
            className={`box ${inUse == "box7" ? "selected" : ""}`}
            id="box7"
            onClick={() => boxClickHandle("box7")}
            value={board.box7}
            onChange={boxInputHandle}
          />
          <input
            className={`box ${inUse == "box8" ? "selected" : ""}`}
            id="box8"
            onClick={() => boxClickHandle("box8")}
            value={board.box8}
            onChange={boxInputHandle}
          />
          <input
            className={`box ${inUse == "box9" ? "selected" : ""}`}
            id="box9"
            onClick={() => boxClickHandle("box9")}
            value={board.box9}
            onChange={boxInputHandle}
          />
        </div>
